...
COPY --from=docker.elastic.co/observability/apm-agent-java:1.45.0 /usr/agent/elastic-apm-agent.jar /app/elastic-apm-agent.jar
...
LABEL \
    ...
    org.label-schema.version="1.45.0" \
