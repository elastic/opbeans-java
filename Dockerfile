...
RUN git clone https://github.com/${JAVA_AGENT_REPO}.git ./ && git checkout ${JAVA_AGENT_BRANCH}
RUN mvn -q -B package -DskipTests -Dmaven.javadoc.skip=true -Dmaven.sources.skip=true -Dmaven.commitid.skip=true
